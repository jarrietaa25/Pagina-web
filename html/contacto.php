...
<body class="fondo">
    <main>
     ...
     <div class="contacto">
        <h1>MANTENETE UNIDO CON NOSOTROS</h1>
     </div>
  </div>
  <h1>Envianos tu contacto y un mensaje que te gustaria dejarnos, y asi nos ponemos en contacto!</h1>

<div class="container text-center">
  <div class="row row-cols-2">
    <div class="col"> <img src="../imagenes/random building graphic design.jpg" class="img" alt="imagenes"></div>
    <div class="col">
      <div class="contacto2">
        <form action="/my-handling-form-page" method="post">
          <ul>
            ...
            <div>
              ...
              <div class="button">
                <button type="submit">Envía su mensaje</button>
              </div>
      </div> 
    </div>
  </div>
